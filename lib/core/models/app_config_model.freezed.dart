...
class _$AppConfigModelImpl implements _AppConfigModel {
  const _$AppConfigModelImpl(
      ...
      final List<String> categories = const ['fresh', 'processed'],
  ...
  @override
  String toString() {
    return 'AppConfigModel(varieties: $varieties, districts: $districts, categories: $categories, minAppVersion: $minAppVersion)';
  }
...
abstract class _AppConfigModel implements AppConfigModel {
  const factory _AppConfigModel(
      ...
      final String minAppVersion}) = _$AppConfigModelImpl;
